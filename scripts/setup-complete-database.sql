-- 🚀 Script SQL Complet - GirlyCrea
-- À exécuter dans Supabase SQL Editor
-- Combine: RLS Policies + Pending Products Table
-- Date: 2025-01-XX

-- ============================================
-- PARTIE 1: PENDING_PRODUCTS TABLE
-- ============================================
-- 📊 Table pour produits en attente de validation (queue)
...
-- ============================================
-- PARTIE 2: TABLES SUPPLÉMENTAIRES
-- ============================================
...
-- ABANDONED_CARTS - Table pour paniers abandonnés (déjà dans RLS mais table à créer si manquante)
...
-- ============================================
-- PARTIE 3: RLS POLICIES COMPLÈTES
-- ============================================
...
-- 11. INDEXES SÉCURITÉ (Performance)
...
WHERE table_name IN ('pending_products', 'reviews', 'promo_codes', 'product_specifications', 'abandoned_carts')
...
-- ✅ Toutes les tables créées: pending_products, reviews, promo_codes, product_specifications, abandoned_carts
